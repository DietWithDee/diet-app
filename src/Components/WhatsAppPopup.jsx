...
export default function WhatsAppPopup({ isOpen, onClose, onConfirm }) {
    ...
    return (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center px-4 animate-in fade-in duration-300">
            ...
            <div className="relative w-full max-w-[340px] overflow-hidden rounded-[1.5rem] border border-white/20 bg-white shadow-[0_20px_50px_rgba(0,0,0,0.3)] animate-in slide-in-from-bottom-8 duration-500 ease-out">
                ...
                <div className="absolute -right-8 -top-8 h-28 w-28 rounded-full bg-green-500/10 blur-3xl"></div>
                <div className="absolute -left-8 -bottom-8 h-28 w-28 rounded-full bg-emerald-500/10 blur-3xl"></div>

                <div className="relative p-6">
                    {/* Icon & Header */}
                    <div className="flex flex-col items-center text-center mb-6">
                        <div className="h-14 w-14 mb-4 flex items-center justify-center rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 shadow-lg shadow-green-500/20">
                        ...
                        <h3 className="text-xl font-black text-gray-900 mb-2">WhatsApp Redirect</h3>
                        <p className="text-gray-600 leading-relaxed text-[13px]">
                            You are about to leave this website to DM us on WhatsApp. Would you like to proceed?
                        </p>
                    </div>
